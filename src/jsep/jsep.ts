...
class Jsep {
   ...
   * @returns {Jsep}
   */
  static addBinaryOp(op_name, precedence, isRightAssociative, isLogicalOp) {
    ...
    if (isLogicalOp) {
      Jsep.logical_ops.add(op_name);
    } else {
      Jsep.logical_ops.delete(op_name);
    }
    return Jsep;
  }
  ...
  static removeAllBinaryOps() {
    Jsep.binary_ops = {};
    Jsep.right_associative.clear();
    Jsep.logical_ops.clear();
...
Object.assign(Jsep, {
  ...
  // Set of binary operations that should be classfied as a *logical* operation
  logical_ops: new Set(["&&", "||"]),
